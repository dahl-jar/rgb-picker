...
public:
    ...
    | Selection functions                                   |
    \*-----------------------------------------------------*/
    bool            SelectLED(unsigned int led_idx);
    bool            SelectLEDs(std::vector<unsigned int> leds);
    bool            SelectSegment(unsigned int zone_idx, unsigned int segment_idx, bool add = false);
    bool            SelectZone(unsigned int zone_idx, bool add = false);
...
private:
    ...
    \*-----------------------------------------------------*/
    std::vector<unsigned int>           previous_selection;
    std::vector<unsigned int>           selected_leds;
...
signals:
    ...
    | Signals                                               |
    \*-----------------------------------------------------*/
    void selectionChanged(int selected_zone, int selected_segment, std::vector<unsigned int>);
